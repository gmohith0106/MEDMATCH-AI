...
export default function PaymentSuccessRedirectPage() {
  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-white rounded-xl border border-[#cbd5e1] p-8 text-center space-y-4">
      ...
      <div className="pt-2">
        <Link
          href="/procurement"
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md bg-pink-600 hover:bg-pink-700 text-white text-xs font-semibold transition-colors"
        >
